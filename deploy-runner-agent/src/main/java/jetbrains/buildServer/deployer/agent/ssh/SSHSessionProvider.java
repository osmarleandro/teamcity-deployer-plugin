...
public class SSHSessionProvider {
  ...
  /**
 * @deprecated Use {@link SSHProcessAdapterOptions#TEAMCITY_DEPLOYER_SSH_CONFIG_PATH} instead
 */
public static final String TEAMCITY_DEPLOYER_SSH_CONFIG_PATH = SSHProcessAdapterOptions.TEAMCITY_DEPLOYER_SSH_CONFIG_PATH;
